        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBankrupt = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: true),
                    BankruptcyCaseStartYear = table.Column<int>(type: "integer", nullable: true),
                    CompanyCreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CompanyLastUpdateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NOR1B1 = table.Column<double>(name: "NOR_1B_1", type: "double precision", nullable: true),
                    NOR1B2 = table.Column<double>(name: "NOR_1B_2", type: "double precision", nullable: true),
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    CoefCreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CoefLastUpdateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
